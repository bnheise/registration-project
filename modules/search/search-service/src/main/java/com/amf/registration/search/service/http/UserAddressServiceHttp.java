	...
	public static java.util.List<com.amf.registration.search.model.UserAddress>
		...
		try {
			MethodKey methodKey = new MethodKey(
				UserAddressServiceUtil.class, "getUsersByZip",
				_getUsersByZipParameterTypes0);
			...
			return (java.util.List
				<com.amf.registration.search.model.UserAddress>)returnObj;
		}
