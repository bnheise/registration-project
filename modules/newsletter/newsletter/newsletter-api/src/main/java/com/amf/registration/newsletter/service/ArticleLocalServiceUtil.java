 ...
 * <code>com.amf.registration.newsletter.service.impl.ArticleLocalServiceImpl</code> and
...
public class ArticleLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.amf.registration.newsletter.service.impl.ArticleLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Article createArticle(long issueNumber) {
		return getService().createArticle(issueNumber);
	}
	 ...
	 */
	public static Article deleteArticle(long issueNumber)
		throws PortalException {

		return getService().deleteArticle(issueNumber);
	}
	...
	public static Article fetchArticle(long issueNumber) {
		return getService().fetchArticle(issueNumber);
	}
	 ...
	 * @throws PortalException if a article with the primary key could not be found
	 */
	public static Article getArticle(long issueNumber) throws PortalException {
		return getService().getArticle(issueNumber);
	}
