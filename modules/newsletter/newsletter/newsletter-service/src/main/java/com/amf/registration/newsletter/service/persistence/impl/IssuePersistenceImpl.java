...
import com.amf.registration.newsletter.exception.NoSuchIssueException;
import com.amf.registration.newsletter.model.Issue;
import com.amf.registration.newsletter.model.impl.IssueImpl;
import com.amf.registration.newsletter.model.impl.IssueModelImpl;
...
public class IssuePersistenceImpl
	...
	public void cacheResult(Issue issue) {
		entityCache.putResult(IssueImpl.class, issue.getPrimaryKey(), issue);
	}
	...
	public void cacheResult(List<Issue> issues) {
		for (Issue issue : issues) {
			if (entityCache.getResult(IssueImpl.class, issue.getPrimaryKey()) ==
					null) {
	...
	public void clearCache(Issue issue) {
		entityCache.removeResult(IssueImpl.class, issue);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(IssueImpl.class, primaryKey);
		}
	}
	 ...
	 */
	@Override
	public Issue create(long issueNumber) {
	 ...
	 */
	@Override
	public Issue remove(long issueNumber) throws NoSuchIssueException {
	...
	public Issue updateImpl(Issue issue) {
		...
		entityCache.putResult(IssueImpl.class, issue, false, true);
	 ...
	 */
	@Override
	public Issue findByPrimaryKey(long issueNumber)
		throws NoSuchIssueException {
	 ...
	 */
	@Override
	public Issue fetchByPrimaryKey(long issueNumber) {
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new IssueModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Issue.class.getName()));
	...
	private static class IssueModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			IssueModelImpl issueModelImpl = (IssueModelImpl)baseModel;

			long columnBitmask = issueModelImpl.getColumnBitmask();

			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(issueModelImpl, columnNames, original);
			}
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |= issueModelImpl.getColumnBitmask(
						columnName);
				}
		...
		private static Object[] _getValue(
			IssueModelImpl issueModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = issueModelImpl.getColumnOriginalValue(
						columnName);
				}
				else {
					arguments[i] = issueModelImpl.getColumnValue(columnName);
				}
			}
