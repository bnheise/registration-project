...
/**
 * Provides the local service interface for UserEvents. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserEventsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserEventsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.amf.registration.monitor.service.impl.UserEventsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user events local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserEventsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public UserEvents deleteUserEvents(long userEventId) throws PortalException;
