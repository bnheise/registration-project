 ...
 * @generated
 */
public abstract class UserEventFinderBaseImpl
	extends BasePersistenceImpl<UserEvent> {

	public UserEventFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return userEventPersistence.getBadColumnNames();
	}
