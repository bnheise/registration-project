...
public class SignupValidatorImpl implements SignupValidator {
	...
	public void validate(String password1, String password2, String screenName, String emailAddress, String firstName,
			...
			String securityAnswer) throws SignupServiceValidationException {
	...
	private String tooLongMessage(String fieldName, int maxLength) {
		return toPrintFriendly(fieldName) + " cannot be greater than " + maxLength + " characters long.";
	}

	private String tooShortMessage(String fieldName, int minLength) {
		return toPrintFriendly(fieldName) + " cannot be less than " + minLength + " characters long.";
	}
